...
import { TableV2FixedDir, TableV2Placeholder } from 'lemon-peel';
...
<style>
.lp-el-table-v2__header-row .custom-header-cell {
  border-right: 1px solid var(--el-border-color);
}

.lp-el-table-v2__header-row .custom-header-cell:last-child {
  border-right: none;
}
...
.lp-primary-color .custom-header-cell {
  padding: 0 4px;
}
</style>
