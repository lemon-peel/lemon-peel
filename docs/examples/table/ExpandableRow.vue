    ...
    <lp-table-column type="expand">
      <template #default="props">
        <div m="4">
          ...
          <h3>Family</h3>
          <lp-table :data="props.row.family" :border="childBorder">
            <lp-table-column label="Name" prop="name" />
            <lp-table-column label="State" prop="state" />
            <lp-table-column label="City" prop="city" />
            <lp-table-column label="Address" prop="address" />
            <lp-table-column label="Zip" prop="zip" />
          </lp-table>
        </div>
      </template>
    </lp-table-column>
