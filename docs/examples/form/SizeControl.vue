<template>
  <div>
    ...
    <lp-radio-group v-model="labelPosition" label="position control">
  ...
  >
    <lp-form-item label="Activity name">
      <lp-input v-model="sizeForm.name" />
    </lp-form-item>
    ...
    <lp-form-item label="Activity type">
      <lp-checkbox-group v-model="sizeForm.type">
    ...
    <lp-form-item label="Resources">
      <lp-radio-group v-model="sizeForm.resource">
