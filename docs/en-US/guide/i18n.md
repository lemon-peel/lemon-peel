...
import zhCn from 'lemon-peel/dist/locale/zh-cn.mjs'

app.use(LemonPeel, { locale: zhCn })
```

## ConfigProvider

Element Plus also provides a Vue component [ConfigProvider](/en-US/component/configProvider)
...
Full documentation refer to: [ConfigProvider](/en-US/component/configProvider)
