...
import VPFullScreenMenu from './full-screen/VpMenu.vue';
import VPFullScreenTranslation from './full-screen/VpTranslation.vue';
import VPFullScreenThemeToggler from './full-screen/VpThemeToggler.vue';
