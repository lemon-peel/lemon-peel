...
import VPLink from '../common/VpLink.vue';
import VPMarkdown from '../common/VpMarkdown.vue';
...
const onVersionChange = val => {
  const ver = releases.value;
  currentRelease.value = ver[ver.findIndex(r => r.name === val)];
};
