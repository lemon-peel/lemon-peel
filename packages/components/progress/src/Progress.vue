  ...
  >
    ...
    >
      <slot :percentage="percentage">
        ...
        <lp-icon v-else><component :is="statusIcon" /></lp-icon>
      </slot>
    </div>
  </div>
</template>
...
import { isFunction, isString } from '@lemon-peel/utils';
...
const stroke = computed(() => {
  const returnValue: string = props.color ? getCurrentColor(props.percentage) : STATUS_COLOR_MAP[props.status] || STATUS_COLOR_MAP.default;
  return returnValue;
});
