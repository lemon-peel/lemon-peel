<template>
  <lp-roving-focus-collection-item
    :id="id"
    :focusable="focusable"
    :active="active"
  >
...
import { useId } from '@lemon-peel/hooks';
import { composeEventHandlers } from '@lemon-peel/utils';
import { EVENT_CODE } from '@lemon-peel/constants';
import { LpCollectionItem as LpRovingFocusCollectionItem, ROVING_FOCUS_COLLECTION_INJECTION_KEY } from './rovingFocusGroup';
import {
