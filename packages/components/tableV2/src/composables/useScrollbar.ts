...
import type { Alignment as ScrollStrategy } from '@lemon-peel/components/virtualList';
...
export { type Alignment as ScrollStrategy } from '@lemon-peel/components/virtualList';