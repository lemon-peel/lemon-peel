...
import { DynamicSizeGrid, FixedSizeGrid } from '@lemon-peel/components/virtualList';
...
import type { DynamicSizeGridInstance, GridDefaultSlotParams, GridItemKeyGetter, GridItemRenderedEvtParams, GridScrollOptions, ResetAfterIndex, Alignment as ScrollStrategy } from '@lemon-peel/components/virtualList';
import type { TableV2HeaderInstance } from './components';
import type { TableV2GridProps } from './grid';

const COMPONENT_NAME = 'LpTableV2Grid';
...
const useTableGrid = (props: TableV2GridProps) => {
  ...
  function resetAfterRowIndex(index: number, forceUpdate = false) {
