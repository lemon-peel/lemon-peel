          ...
          >
            <lp-sub-menu index="1" ref="subMenu">
              ...
              <lp-menu-item-group>
                ...
                <lp-menu-item index="1-1">选项1</lp-menu-item>
                <lp-menu-item index="1-2">选项2</lp-menu-item>
              </lp-menu-item-group>
              <lp-menu-item-group title="分组2">
                <lp-menu-item index="1-3">选项3</lp-menu-item>
              </lp-menu-item-group>
              <lp-sub-menu index="1-4">
                <template #title>选项4</template>
                <lp-menu-item index="1-4-1">选项1</lp-menu-item>
              </lp-sub-menu>
            </lp-sub-menu>
      ...
      `<div>
        <lp-menu default-active="2-2" mode="vertical">
          ...
          <lp-sub-menu index="2" ref="submenu">
            ...
            <lp-menu-item index="2-1">选项1</lp-menu-item>
            <lp-menu-item index="2-2" ref="submenuItem2">选项2</lp-menu-item>
            <lp-menu-item index="2-3">选项3</lp-menu-item>
          </lp-sub-menu>
          <lp-menu-item index="3">订单管理</lp-menu-item>
        </lp-menu>
      </div>`,
    );
    ...
    const wrapper = _mount(
      `<lp-menu :default-openeds="defaultOpeneds">
        ...
        <lp-sub-menu index="2" ref="submenu1">
          ...
          <lp-menu-item index="2-1">选项1</lp-menu-item>
          <lp-menu-item index="2-2" ref="submenu1Item2">选项2</lp-menu-item>
          <lp-menu-item index="2-3">选项3</lp-menu-item>
        </lp-sub-menu>
        <lp-sub-menu index="3" ref="submenu2">
          <template slot="title">default opened订单管理</template>
          <lp-menu-item index="3-1">选项1</lp-menu-item>
          <lp-menu-item index="3-2" ref="submenu2Item2">选项2</lp-menu-item>
          <lp-menu-item index="3-3">选项3</lp-menu-item>
        </lp-sub-menu>
      </lp-menu>`,
      {
        data() {
    ...
    const wrapper = _mount(
      `<lp-menu mode="vertical" default-active="1">
        <lp-menu-item-group title="分组一" ref="group1">
          ...
          <lp-menu-item index="2">导航二</lp-menu-item>
        </lp-menu-item-group>
        <lp-sub-menu index="5">
          <template slot="title">导航五</template>
          <lp-menu-item-group title="分组二">
            <lp-menu-item index="5-1">选项1</lp-menu-item>
            <lp-menu-item index="5-2">选项2</lp-menu-item>
          </lp-menu-item-group>
        </lp-sub-menu>
      </lp-menu>`,
    );
