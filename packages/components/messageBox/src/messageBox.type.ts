...
export interface LpMessageBoxOptions {
  /**
...
export type LpMessageBoxShortcutMethod = ((
  message: LpMessageBoxOptions['message'],
  title: LpMessageBoxOptions['title'],
...
export interface ILpMessageBox {
  ...
  alert: LpMessageBoxShortcutMethod;

  /** Show a confirm message box */
  confirm: LpMessageBoxShortcutMethod;

  /** Show a prompt message box */
  prompt: LpMessageBoxShortcutMethod;
